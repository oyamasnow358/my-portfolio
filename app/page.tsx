  ...
  return (
    <div className="min-h-screen bg-white text-slate-900 font-sans selection:bg-blue-100 selection:text-blue-900 overflow-hidden relative">
      ...
      <div className="relative z-10 pt-60">
        ...
        {/* 3. メインメニュー (ここに「各機能」へのリンクカードを配置) */}
        <section className="px-6 md:px-20 mb-40">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
             <StaggeredMenu>
                {/* ★変更: クリックで /page/select に遷移 */}
                <MenuCard title="MieeL 各機能" sub="APPLICATIONS" icon={<Layers />} onClick={goToSelect} big />
                ...
                {/* 分析ツールも page/select に含まれますが、ここにも一応残すか、selectへ誘導するか。今回はselectにあるので削除も可ですが、デザイン上残します */}
                <MenuCard title="分析ツール" sub="FOR RESEARCHERS" icon={<Activity />} onClick={() => router.push("/page/page9")} />
             </StaggeredMenu>
          </div>
        </section>
